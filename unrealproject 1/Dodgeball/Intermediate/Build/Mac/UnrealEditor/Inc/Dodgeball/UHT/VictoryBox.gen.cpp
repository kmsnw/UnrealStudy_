...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVictoryBox_OnBeginOverlap_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AVictoryBox, nullptr, "OnBeginOverlap", Z_Construct_UFunction_AVictoryBox_OnBeginOverlap_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVictoryBox_OnBeginOverlap_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVictoryBox_OnBeginOverlap_Statics::VictoryBox_eventOnBeginOverlap_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVictoryBox_OnBeginOverlap_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVictoryBox_OnBeginOverlap_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_AVictoryBox;
UClass* AVictoryBox::GetPrivateStaticClass()
{
	using TClass = AVictoryBox;
	if (!Z_Registration_Info_UClass_AVictoryBox.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("VictoryBox"),
			Z_Registration_Info_UClass_AVictoryBox.InnerSingleton,
			StaticRegisterNativesAVictoryBox,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AVictoryBox.InnerSingleton;
}
UClass* Z_Construct_UClass_AVictoryBox_NoRegister()
{
	return AVictoryBox::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AVictoryBox_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AVictoryBox_OnBeginOverlap, "OnBeginOverlap" }, // 935063422
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_VictoryBox_h__Script_Dodgeball_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AVictoryBox, AVictoryBox::StaticClass, TEXT("AVictoryBox"), &Z_Registration_Info_UClass_AVictoryBox, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVictoryBox), 1172493860U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_VictoryBox_h__Script_Dodgeball_3195426802(TEXT("/Script/Dodgeball"),
	Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_VictoryBox_h__Script_Dodgeball_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_VictoryBox_h__Script_Dodgeball_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
