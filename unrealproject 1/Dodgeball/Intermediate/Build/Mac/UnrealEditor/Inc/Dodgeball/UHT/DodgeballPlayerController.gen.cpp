...
FClassRegistrationInfo Z_Registration_Info_UClass_ADodgeballPlayerController;
UClass* ADodgeballPlayerController::GetPrivateStaticClass()
{
	using TClass = ADodgeballPlayerController;
	if (!Z_Registration_Info_UClass_ADodgeballPlayerController.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("DodgeballPlayerController"),
			Z_Registration_Info_UClass_ADodgeballPlayerController.InnerSingleton,
			StaticRegisterNativesADodgeballPlayerController,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ADodgeballPlayerController.InnerSingleton;
}
UClass* Z_Construct_UClass_ADodgeballPlayerController_NoRegister()
{
	return ADodgeballPlayerController::GetPrivateStaticClass();
}
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "//\xeb\xb8\x94\xeb\xa3\xa8\xed\x94\x84\xeb\xa6\xb0\xed\x8a\xb8 \xed\x81\xb4\xeb\x9e\x98\xec\x8a\xa4\xec\x97\x90\xec\x84\x9c \xed\x8e\xb8\xec\xa7\x91 \xea\xb0\x80\xeb\x8a\xa5\n" },
#endif
		{ "ModuleRelativePath", "DodgeballPlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xeb\xb8\x94\xeb\xa3\xa8\xed\x94\x84\xeb\xa6\xb0\xed\x8a\xb8 \xed\x81\xb4\xeb\x9e\x98\xec\x8a\xa4\xec\x97\x90\xec\x84\x9c \xed\x8e\xb8\xec\xa7\x91 \xea\xb0\x80\xeb\x8a\xa5" },
#endif
	};
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "// \xec\xb0\xb8\xec\xa1\xb0 \xec\xa0\x80\xec\x9e\xa5\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "DodgeballPlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xec\xb0\xb8\xec\xa1\xb0 \xec\xa0\x80\xec\x9e\xa5" },
#endif
	};
#endif // WITH_METADATA
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballPlayerController_h__Script_Dodgeball_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ADodgeballPlayerController, ADodgeballPlayerController::StaticClass, TEXT("ADodgeballPlayerController"), &Z_Registration_Info_UClass_ADodgeballPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADodgeballPlayerController), 916225287U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballPlayerController_h__Script_Dodgeball_1923753678(TEXT("/Script/Dodgeball"),
	Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballPlayerController_h__Script_Dodgeball_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballPlayerController_h__Script_Dodgeball_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
