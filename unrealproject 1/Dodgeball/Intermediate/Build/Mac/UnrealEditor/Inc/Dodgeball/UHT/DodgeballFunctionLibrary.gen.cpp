...
FClassRegistrationInfo Z_Registration_Info_UClass_UDodgeballFunctionLibrary;
UClass* UDodgeballFunctionLibrary::GetPrivateStaticClass()
{
	using TClass = UDodgeballFunctionLibrary;
	if (!Z_Registration_Info_UClass_UDodgeballFunctionLibrary.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("DodgeballFunctionLibrary"),
			Z_Registration_Info_UClass_UDodgeballFunctionLibrary.InnerSingleton,
			StaticRegisterNativesUDodgeballFunctionLibrary,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UDodgeballFunctionLibrary.InnerSingleton;
}
UClass* Z_Construct_UClass_UDodgeballFunctionLibrary_NoRegister()
{
	return UDodgeballFunctionLibrary::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h__Script_Dodgeball_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDodgeballFunctionLibrary, UDodgeballFunctionLibrary::StaticClass, TEXT("UDodgeballFunctionLibrary"), &Z_Registration_Info_UClass_UDodgeballFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDodgeballFunctionLibrary), 2237091605U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h__Script_Dodgeball_1191079834(TEXT("/Script/Dodgeball"),
	Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h__Script_Dodgeball_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_kmsnw_Documents_GitHub_UnrealStudy__unrealproject_1_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h__Script_Dodgeball_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
