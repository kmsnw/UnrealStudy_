...
AEnemyCharacter::AEnemyCharacter()
{
	...
	LookAtActorComponent = CreateDefaultSubobject<ULookAtActorComponent>(TEXT("Look At Actor Componenet"));
...
void AEnemyCharacter::ThrowDodgeball()
{
	...
	Projectile = GetWorld()->SpawnActorDeferred<ADodgeballProjectile>(DodgeballClass, SpawnTransform);
